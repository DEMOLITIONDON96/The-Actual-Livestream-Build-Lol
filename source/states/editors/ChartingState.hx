...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Flash Screen', "Value 1: RGB ID of the color you want\nValue 2: How long the flash lasts"],
		['Camera Fade (Game)', "Value 1: Affects the visibility of the camera (0-1)\nValue 2: How long it takes"],
		['Camera Fade (HUD)', "Same instructions as \"Camera Fade (Game)\""],
		['Alter Camera Zoom', "Value 1: Sets the zoom of the camera\nValue 2: How long it takes to change zoom"],
		['Alter Camera Speed', "Value 1: Sets the speed of the camera movement\nValue 2: Does nothing, leave it blank"],
		['Alter Camera Angle (Game)', "Value 1: Sets the angle of the camera\nValue 2: How long it takes to change angle"],
		['Alter Camera Angle (HUD)', "Read instructions on \"Alter Camera Angle (Game) \""],
		['Add Cinematic Bars', "Value 1: How thick they will be\nValue 2: How long it takes to transition"],
		['Remove Cinematic Bars', "Value 1: How long it takes to transition\nValue 2: Does nothing, leave it blank"],
		["Summon Line Effect", "Value 1: RGB value of the line effect's color\nValue 2: How long it stays on screen"],
		['Alter Stage Visibility', "Value 1: Sets visibility value of the stage\nValue 2: How long it takes to update visibility"],
		['Alter Chromatic Aberration', "Value 1: Sets intensity of the chrom shader\nValue 2: How long it takes to set intensity"],
		['Toggle BF Trail', "Do nothing, does all the work for you"],
		['Toggle Dad Trail', "Do nothing, does all the work for you"],
		['Flash Image', "Value 1: Name of the image you want to summon\nValue 2: How long it takes to fade away"],
		['GF Goes to Heaven', "She goes to heaven, no need to use values here"],
		['BF Goes to Hell (GF Goes to Heaven D-Sides)', "BF fucking dies lmao, no need to use values here"],
		['Move Stage Camera (X Position)', "Value 1: Sets the X position\nValue 2: How long it takes to reach that point"],
		['Move Stage Camera (Y Position)', "Value 1: Sets the Y position\nValue 2: How long it takes to reach that point"],
		['Tween Fire Background', "Value 1: Alpha Value\nValue 2: Timer Value\n(DO NOT USE THESE OUTSIDE OF LUNACY, GAME WILL CRASH)"],
		['Fast Tween Fire BG', "Value 1: Alpha Value\nValue 2: Timer Value\n(DO NOT USE THESE OUTSIDE OF LUNACY, GAME WILL CRASH)"]
	];
